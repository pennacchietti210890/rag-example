...
class DocumentManager:
    ...
    def process_document(self, text: str, embedding_model: SentenceTransformer) -> Dict[str, int]:
        ...
        with self._lock:
            try:
                ...
                if not self._chunks:
                    raise DocumentProcessingError("No valid chunks were created from the document")
    ...
    def search_chunks(self, query: str, embedding_model: SentenceTransformer, k: int = 3) -> List[str]:

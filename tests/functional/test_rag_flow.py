...
class TestRAGFlow:
    ...
    def test_end_to_end_flow(self, mock_get_models, mock_generate_response, mock_api_responses, sample_pdf):
        """Test the complete RAG flow from upload to query"""
        # Setup mocks
        mock_get_models.return_value = ["llama3-70b-8192"]
        mock_generate_response.return_value = {"answer": "The revenue was $10 million in Q1 2023."}
        ...
        models_response = requests.get("http://testserver/models/?encrypted_api_key=test_encrypted_key")
        ...
        assert query_response.json()["answer"] == "The revenue was $10 million in Q1 2023."

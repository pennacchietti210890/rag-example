...
class TestAPIEndpoints:
    ...
    def test_models_endpoint_error(self, mock_get_models, mock_api_responses):
        ...
        # Mock error response
        mock_api_responses.get("http://testserver/models/?encrypted_api_key=test_key", 
                              status_code=503, 
    ...
    def test_upload_endpoint(self, mock_fitz_open, mock_process_document, mock_api_responses):
    ...
    def test_query_endpoint_no_document(self, mock_api_responses):
        ...
        # Mock error response
        mock_api_responses.post("http://testserver/query/", 
                               status_code=400, 
